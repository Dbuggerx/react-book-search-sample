...
apiRouter.get('/books', (req: express.$Request, res: express.$Response) => {
...
apiRouter.param(
  'bookId',
  (req: express.$Request, res: express.$Response, next: express.NextFunction, id: string) => {
...
apiRouter.get('/books/:bookId', (req: express.$Request, res: express.$Response) => {
  res.header('Access-Control-Allow-Origin', '*');
  res.header('access-control-expose-headers', 'x-total-count');
