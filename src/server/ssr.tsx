...
g.XMLHttpRequest = require('xmlhttprequest').XMLHttpRequest;
...
async function renderFullPage(html: string, preloadedState: {}, asyncChunksScriptTags: string) {
...
async function handleSsrReady(state: {}, loadedChunkNames: string[], renderedHtml: string) {
